...
from model import GNN, GNN_graphpredGNN,finetune_ib
...
def main():
    ...
    #set up model
    model = finetune_ib(args.num_layer, args.emb_dim, num_tasks, JK = args.JK, drop_ratio = args.dropout_ratio, graph_pooling = args.graph_pooling, gnn_type = args.gnn_type)
