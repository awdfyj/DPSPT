...
class GNN_graphpred_ib(torch.nn.Module):
    ...
    def forward(self, *argv):
        ...
        print('gaussian_noise.shape:',gaussian_noise.shape)
        print('torch.exp(logstd).shape:',torch.exp(logstd).shape)
        print('z.shape:',z.shape)
        print('mu_p.shape:',self.mu_p.shape)
        print('std_p.shape:',self.std_p.shape)
